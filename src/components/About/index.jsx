...
const About = () => {
  return (
      <section className="h-auto bg-white px-6 sm:px-10 md:px-20 pt-20 pb-20 md:pt-40 md:pb-40">
          ...
          <div className="mt-10 md:mt-0">
            <div className="w-full sm:w-[400px] md:w-[630px] h-auto md:h-[236px] bg-[#6a54ff] rounded p-6 md:p-8">
              ...
              <div className="relative w-full">
                ...
                />
                <button
                    className="absolute right-1 top-1/2 transform -translate-y-1/2 bg-[#59e0fe] rounded text-sm font-normal uppercase text-[#211a4e] py-2 px-4 w-[120px] sm:w-[165px] h-[40px] sm:h-[52px]">
                  Спробувати
                </button>
              </div>
            </div>
