...
const Questions = () => {
  return (
      <section className="min-h-screen bg-white text-black px-4 sm:px-10 pt-20 sm:pt-40">
        ...
        <div>
          <div className="w-full max-w-[846px] mx-auto">
            ...
            <div className="mb-2">
              <div className="bg-gray-100 text-lg sm:text-2xl font-medium text-black p-4 flex justify-between items-center rounded-lg">
