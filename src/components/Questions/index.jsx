...
const Questions = () => {
  return (
    <section className="h-screen bg-white text-black px-20 pt-40">
      ...
      <div>
        <div className="w-full max-w-[846px] mx-auto">
          <div className="mb-2">
            <div className="bg-[#6A54FF] text-white text-2xl font-normal p-4 flex justify-between items-center rounded-t-lg w-full">
              Що таке TradeBlade
              <span className="text-white">▲</span>
            </div>
            <div className="bg-[#6A54FF] text-[#e0d8ff] p-4 rounded-b-lg text-base font-normal">
              <p className="mb-4">
          ...
          <div className="mb-2">
            <div className="bg-gray-100 text-2xl font-medium text-black p-4 flex justify-between items-center rounded-lg">
